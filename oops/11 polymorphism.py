...
# polymorphism
employees=[softwareengineer("max",34,3900129201123,"junior"),softwareengineer("duke",32,3900129201123,"senior"),designer("lisa",20,30303)]


def motivate_employee(employees):
    for employee in employees:
        employee.work()# we call only employee not call the 
